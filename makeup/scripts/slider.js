...
$(document).ready(function() {
 $(".sign_in a.auth").on('mouseenter', function() {
        
        $(".sign_in .auth, .sign_in .registration, .sign_in .divider").hide();
        $(".sign_in").removeClass('push_right');
        $(".fast-login-form").show();
    });
 
 $('.close-fast-login').on('click', function() {
  $(".sign_in .auth, .sign_in .registration, .sign_in .divider").show();
        $(".sign_in").addClass('push_right');
        $(".fast-login-form").hide();
 })    
}); 
